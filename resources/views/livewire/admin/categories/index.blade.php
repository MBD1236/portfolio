<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <flux:modal.trigger name="ajout-categorie">
            <flux:button icon="plus" wire:click='resetForm'>Ajouter une catégorie</flux:button>
        </flux:modal.trigger>
    </div>
            ...
            <tbody>
                ...
                <tr
                    ...
                    <td class="px-6 py-2 flex justify-start gap-1">
                        <flux:modal.trigger name="editer-categorie">
                            <flux:button icon="pencil-square" size="sm" wire:click="edit({{ $categorie }})" />
                        </flux:modal.trigger>
                        <flux:button icon="trash" size="sm" wire:click="delete({{ $categorie->id }})" />
                    </td>
                </tr>
                @empty
                <tr>
    ...
    <flux:modal name="ajout-categorie" class="md:w-150" wire:ignore.self>
        <form wire:submit="save" class="space-y-6">
            <div>
                <flux:heading size="lg">Ajouter une catégorie</flux:heading>
            </div>
            <flux:input wire:model='name' label="Nom" placeholder="Catégorie" />
    ...
    <flux:modal name="editer-categorie" class="md:w-150" wire:ignore.self>
        <form wire:submit="update" class="space-y-6">
            <div>
                <flux:heading size="lg">Editer une catégorie</flux:heading>
            </div>
            <flux:input wire:model='name' label="Nom" placeholder="Catégorie" />
            <flux:textarea wire:model='description' label="Description" placeholder="Description" />
            <div class="flex">
