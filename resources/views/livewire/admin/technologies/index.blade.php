<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <flux:modal.trigger name="ajout-technologie">
            <flux:button icon="plus" wire:click='resetForm'>Ajouter une technologie</flux:button>
        </flux:modal.trigger>
    </div>
            ...
            <tbody>
                ...
                <tr
                    ...
                    <td class="px-6 py-2 flex justify-start gap-1">
                        <flux:modal.trigger name="editer-technologie">
                            <flux:button icon="pencil-square" size="sm" wire:click="edit({{ $technologie }})" />
                        </flux:modal.trigger>
                        <flux:button icon="trash" size="sm" wire:click="delete({{ $technologie->id }})" />
                    </td>
                </tr>
                @empty
                <tr>
    ...
    <flux:modal name="ajout-technologie" class="md:w-150" wire:ignore.self>
        <form wire:submit="save" class="space-y-6">
            <div>
                <flux:heading size="lg">Ajouter une technologie</flux:heading>
            </div>
            <flux:input wire:model='name' label="Nom" placeholder="Nom" />
            <flux:input type="file" wire:model='ico' label="Icône" placeholder="Icône" />
            <div class="flex">
                <flux:spacer />
    ...
    <flux:modal name="editer-technologie" class="md:w-150" wire:ignore.self>
        <form wire:submit="update" class="space-y-6">
            <div>
                <flux:heading size="lg">Editer une technologie</flux:heading>
            </div>
            <flux:input wire:model='name' label="Nom" placeholder="Nom" />
            <flux:input type="file" wire:model='ico' label="Icône" placeholder="Icône" />
            <div class="flex">
